...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Projetos> listaProj = new ArrayList<>();
        ...
        while (continuar) {
            ...
            System.out.println("2  Abrir Projeto                 ");
    ...
    public static Projetos novoProjeto(ArrayList<Projetos> listaProj) {
        Scanner input = new Scanner(System.in);
    ...
    public static void editProj(ArrayList<Colaborador> listaColab, ArrayList<Projetos> listaProj) {
        Scanner input = new Scanner(System.in);
        ...
        do {
            ...
            if (!existeProj) {
                System.out.println("Esse projeto não nome "
                        + "ou nome incorreto.");
            }
        } while (!existeProj);
        ...
        switch (decisao) {
            ...
            case 2:
                if (listaProj.get(iProj).getStatus() == 1) {
                    ...
                    colab = listaProj.get(iProj).getListaColaboradores();
                    for (int i = 0; i < colab.size(); i++) {
                        if (colab.get(i) instanceof Professor) {
                            existeProf = true;
                        }
                    }
                    if (!existeProf) {
    ...
    public static void publicar(ArrayList<Colaborador> listaColab, ArrayList<Projetos> listaProj, ArrayList<Publicacao> listaPubli) {
        Scanner input = new Scanner(System.in);
        ...
        for (int i = 0; i < listaPubli.size(); i++) {
            if (listaPubli.get(i).getTitulo().equals(titulo)) {
                iPubli = i;
            }
        }
